package com.example.crudbiblioteca.adapter
...
import com.example.crudbiblioteca.R
    ...
    ): RecyclerView.Adapter<adapterLibro.MyHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): adapterLibro.MyHolder {
        var itemView= LayoutInflater.from(context).inflate(R.layout.item_lista_de_libros,parent,false)
